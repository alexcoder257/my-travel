...
const itineraryData = [
  ...
  { day: 1, date: "2026-04-29", time: "19:30", location: "Changi → Aljunied MRT", activity: "🚇 MRT to Hotel", estimatedPrice: { amount: 3.78, currency: "SGD" }, notes: "Changi T2 → Tanah Merah (MUST transfer) → Aljunied → Walk 8 min", order: 4 },
  ...
  // Day 2: Thu 30/4
  { day: 2, date: "2026-04-30", time: "07:30", location: "Dhoby Ghaut", activity: "☕ Breakfast: Ya Kun Kaya Toast", estimatedPrice: { amount: 12, currency: "SGD" }, notes: "Kaya toast + soft boiled eggs + kopi | MRT: Aljunied → Dhoby Ghaut", order: 1 },
  ...
  { day: 2, date: "2026-04-30", time: "11:30", location: "Chinatown Complex", activity: "🏮 Lunch: Tian Tian + Mei Heong Yuen Dessert", estimatedPrice: { amount: 25, currency: "SGD" }, notes: "Hainanese chicken rice + dessert | MRT: City Hall → Chinatown", order: 4 },
  { day: 2, date: "2026-04-30", time: "13:15", location: "Kampong Glam cluster", activity: "🕌 Kampong Glam (Sultan Mosque + Haji Lane + Bugis)", estimatedPrice: { amount: 15, currency: "SGD" }, notes: "Street art, Haji Lane shopping, Sultan Mosque | MRT: Chinatown → Bugis", order: 5 },
